...
start cmd.exe /c "cd /d %DEVELOPMENT_HOME%\currency-conversion-service && mvn spring-boot:run -Dspring-boot.run.arguments=--server.port=8001

start cmd.exe /c "cd /d %DEVELOPMENT_HOME%\currency-exchange-service && mvn spring-boot:run

start cmd.exe /c "cd /d %DEVELOPMENT_HOME%\currency-exchange-service && mvn spring-boot:run -Dspring-boot.run.arguments=--server.port=8101